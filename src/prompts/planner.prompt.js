...
## 時效性要求（極重要）
- 今天是 ${new Date().toLocaleDateString('zh-TW', { year: 'numeric', month: 'long', day: 'numeric' })}
- search_keywords 必須包含年份，優先搜尋近兩年資料
- 例如：「建滔集團 2024 年報 營收」而非「建滔集團 營收」
- 對於企業財務數據，搜尋詞應指向年報、財報、法說會等一手資料

## 市場研究搜尋詞規範（market 模式）
- 必須有至少一個子問題，其 zh 搜尋詞包含「進口 出口 金額 統計」或「同業公會 年報」等統計導向詞彙
- 台灣市場研究優先引用來源：國際貿易署（trade.gov.tw）、各同業公會（如 tfma.org.tw）、主計總處（dgbas.gov.tw）
- 例如：「台灣家具進口 出口 金額 2023 2024 統計」「台灣家具工業同業公會 年報 進口」
